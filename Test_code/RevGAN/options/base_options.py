...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--loadSize', type=int, default=32, help='scale images to this size')
        parser.add_argument('--fineSize', type=int, default=32, help='then crop to this size')
        ...
        parser.add_argument('--model', type=str, default='unpaired_revgan',
        ...
        parser.add_argument('--display_winsize', type=int, default=1, help='display window size')
